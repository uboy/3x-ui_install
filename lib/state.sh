...
STATE_TRACKED_KEYS=(
  ...
  PORT_XUI_PANEL PORT_XUI_REALITY PORT_OPENVPN PORT_OPENCONNECT PORT_AMNEZIA PORT_DUMBPROXY
  ...
  INSTALL_XUI INSTALL_OPENVPN INSTALL_OPENCONNECT INSTALL_AMNEZIA INSTALL_DUMBPROXY
  AUTO_CREATE_INBOUND VPN_USER VPN_PASS VPN_EXCLUDE_ROUTES
)
